//Bo52_08032021165744550.STAT.TRIANGULATION.
//TRIANGULATION_08032021165744550
namespace utility2022
{
    static public class stCube256_vertex8_exists_code
    {
        static public string INFO = "ARRAY";
        static public string PRODUCT = "Код содержит номер вершины Блока";
        static public bool FIXED = false;

        static public byte[][] ИндексыВершины = new byte[][]
        {
            new byte[]//0
            {
            },
