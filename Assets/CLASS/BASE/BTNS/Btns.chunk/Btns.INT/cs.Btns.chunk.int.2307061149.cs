...
namespace LIB.cs2307061149_БлокиЧанка_Интерфейс
{
    ...
    public interface IClass : cs2307031414_Default.IClass
    {
        ...
        cs2307061242_Чанк_Интерфейс.IClass ЧАНК { get; }
    }
        ...
        where TEDIT : cs2307091511_РедакторБлоков.Class, new()
    {
        ...
        #region ЧАНК
        private cs2307061242_Чанк_Интерфейс.IClass _chunk; public cs2307061242_Чанк_Интерфейс.IClass ЧАНК => _chunk;
        #endregion
        #region Блоки
        private cs2307091713_Блоки_Добавление.IClass _btns; public cs2307091713_Блоки_Добавление.IClass Блоки => _btns;
        #endregion
        #region РедакторБлоков
        private TEDIT _edit; public TEDIT РедакторБлоков => _edit;
        #endregion
        #region СозданиеМеша
        private TMESH _create_mesh; public TMESH СозданиеМеша => _create_mesh;
        #endregion
        public Class(object ЧАНК)
        {
            _chunk = ЧАНК as cs2307061242_Чанк_Интерфейс.IClass;
