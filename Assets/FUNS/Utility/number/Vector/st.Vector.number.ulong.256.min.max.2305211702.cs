...
namespace LIB.st2305211702
{
    ...
    static public class Class
    {
        ...
        static public ulong fun230521170203_ПолучитьНомер3(this Vector3 v) => fun230521170206_ПолучитьНомер2(new Vector2(v.x, v.y)) + field230521170202 * (ulong)(v.z + field230521170200);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="v"></param>
        /// <returns></returns>
        static public ulong fun230521170206_ПолучитьНомер2(this Vector2 v) => (ulong)(v.x + field230521170200) + field230521170201 * (ulong)(v.y + field230521170200);
        /// <summary>
        /// GET_V
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        static public Vector3 fun230521170204_ПолучитьВектор3(this ulong id)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        static public Vector2 fun230521170207_ПолучитьВектор2(this ulong id)
        {
        ...
        {
            ulong id = v.fun230521170203_ПолучитьНомер3();
            Vector3 V = id.fun230521170204_ПолучитьВектор3();
